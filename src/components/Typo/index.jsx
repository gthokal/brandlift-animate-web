            ...
            <>
                <div className={styles.typoFlex}>
                    ...
                    {/* {sections.map((sec, idx) => (
                        <section key={idx} className="py-20" style={{ minHeight: "100vh", padding: "100px 0" }}>
                            <AnimatedTitle title={sec.title} />
                        </section>
                    ))} */}
                    <AnimatedTitle />
...
//       <AnimatedTitle
//         title={"Welcome to <br /> BrandLift Media"}
//         containerClass="text-4xl md:text-6xl font-bold text-center"
//       />
//     </main>
//   );
// }
